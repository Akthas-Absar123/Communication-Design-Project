...
class transmit_txtfile(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "transmit_txtfile")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'F:\\test1.txt', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'F:\\output1.txt', False)
...
def main(top_block_cls=transmit_txtfile, options=None):
